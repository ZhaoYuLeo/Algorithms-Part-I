 ...
 * by a function known as the inverse Ackermann function and is less than 5 for any
 * conceivable practical value of N.
 */
public class Ex_13_WeightedQuickUnionPathCompression  {
    ...
    public Ex_13_WeightedQuickUnionPathCompression(int N) {
        count = N;
        id = new int[N];
        sz = new int[N];
        for (int i = 0; i < N; i += 1) {
    ...
    public static void main(String[] args) {
        int N = 10;
        Ex_13_WeightedQuickUnionPathCompression uf = new Ex_13_WeightedQuickUnionPathCompression(N);
        // input pairs: 0-1 2-3 4-5 6-7 0-2 4-6 4-0 will create path 3-2-5-4 of length 4
        // union 3-8 will reduce the length by 1
